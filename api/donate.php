...
if(isset($_POST["nick"]) && isset($_POST["coins"]) && !empty($_POST["nick"]) && !empty($_POST["coins"]))
{
if(!isset($result[0]))
			{
...
echo "<script type=\"text/javascript\"> $('#donateModal').modal('hide'); location.reload();</script>";
}
?>
